...
- ⚙️ Strong interest in **Backend, System Design & Scalable Applications**
- 🛡️ Career goal: **Defense Industry & Enterprise Software**
...
🧩 Full-stack leave management platform with role-based access and visual calendar.

- 🛠️ **React + Spring Boot**
- 🔐 Role-based authorization
- 📊 Dynamic leave balance calculation

🔗 Repo: [Annual Leave Project](#)

---

### 🔹 Product Management / PIM System
📦 Scalable product & category management system.

- 🛠️ **Next.js + REST API**
- 🔄 Drag & Drop Category Tree
